...
select c.country_name, 
    ...
    else "Warm" end ) as weather_type from countries c join weather w on c.country_id = w.country_id where w.day between '2019-11-01' and '2019-11-30' group by c.country_id;
